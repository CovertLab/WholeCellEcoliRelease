...
"""
UniquePolypeptideElongationEnzlim

Translation elongation sub-model.  Enzymatically (not metabolically) limited.
...
class UniquePolypeptideElongationEnzlim(wholecell.processes.process.Process):
	""" UniquePolypeptideElongationEnzlim """

	_name = "UniquePolypeptideElongationEnzlim"
	...
	def __init__(self):
		...
		super(UniquePolypeptideElongationEnzlim, self).__init__()


	# Construct object graph
	def initialize(self, sim, kb):
		super(UniquePolypeptideElongationEnzlim, self).initialize(sim, kb)
