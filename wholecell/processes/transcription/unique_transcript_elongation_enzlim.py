...
"""
UniqueTranscriptElongationEnzlim

Transcription elongation sub-model.  Enzymatically (not metabolically) limited.
...
class UniqueTranscriptElongationEnzlim(wholecell.processes.process.Process):
	""" UniqueTranscriptElongationEnzlim """

	_name = "UniqueTranscriptElongationEnzlim"
	...
	def __init__(self):
		...
		super(UniqueTranscriptElongationEnzlim, self).__init__()


	# Construct object graph
	def initialize(self, sim, kb):
		super(UniqueTranscriptElongationEnzlim, self).initialize(sim, kb)
	...
	def calculateRequest(self):
		...
		self.h2o.requestIs(self.activeRnaPolys.total())
