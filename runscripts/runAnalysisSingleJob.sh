...
runprogram()
{
	...
	for SCRIPT in $SCRIPTS; do
		...
		python2.7 $SCRIPT $MY_SPECIFIC_RESULTS_DIR $MY_SPECIFIC_PLOTS_DIR ${OUT_NAME}.pdf --kbFile "${WORK_DIR}/$(basename $CODE_DIR)/out/${SUBMISSION_TIME}/kb/KnowledgeBase_Fit.cPickle"
