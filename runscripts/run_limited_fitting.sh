...
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=1 DESC="Both fit" \
...
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=1 DESC="Ribosomes fit" \
python runscripts/fw_queue.py

echo Submitting job 3 - fit only RNA polymerases

DISABLE_RIBOSOME_CAPACITY_FITTING=1 DISABLE_RNAPOLY_CAPACITY_FITTING=0 \
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=1 DESC="RNApoly fit" \
python runscripts/fw_queue.py
...
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=1 DESC="Neither fit" \
python runscripts/fw_queue.py
