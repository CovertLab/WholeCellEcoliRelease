...
PARALLEL_FITTER=1 \
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=8 DESC="Both fit" \
...
PARALLEL_FITTER=1 \
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=8 DESC="Ribosomes fit" \
python runscripts/fw_queue.py
...
PARALLEL_FITTER=1 \
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=8 DESC="RNApoly fit" \
python runscripts/fw_queue.py
...
PARALLEL_FITTER=1 \
SINGLE_DAUGHTERS=1 N_GENS=8 N_INIT_SIMS=8 DESC="Neither fit" \
python runscripts/fw_queue.py
