...
PYTHONPATH=$PWD DESC="tRNA Charging" SINGLE_DAUGHTERS=1 N_GENS=8 TRNA_CHARGING=1 COMPRESS_OUTPUT=1 PLOTS=ACTIVE RAISE_ON_TIME_LIMIT=1 python runscripts/fireworks/fw_queue.py
