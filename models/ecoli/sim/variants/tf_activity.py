...
Modifies:
	...
	sim_data.external_state.environment.saved_timelines
...
def tf_activity(sim_data, index):
	...
	sim_data.external_state.environment.current_timeline_id = tf + "__" + tfStatus
	sim_data.external_state.environment.saved_timelines[sim_data.external_state.environment.current_timeline_id] = []
	sim_data.external_state.environment.saved_timelines[sim_data.external_state.environment.current_timeline_id].append((
		0.0,
